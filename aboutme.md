...
> In this project, I developed the VIO based algorithm using single apriltag to do quadrotor global localization and control. For global localization part, I developed the on-board ROS package for real time apriltag detection and quadrotor pose estimation. I also addressed the light and computation time problem in this part. For the control part, I re-developed the MAV manager package to fit it into the new algorithm: before quadrotor detects the apriltag and defines the global frame aligning with the detected single apriltag, it can go to relative position based on takeoff frame. After it detects the apriltag, it can go to global position based on it. And every time it sees the apriltag again, it can refresh and correct its global position. 
...
### Omnidirectional Mobile Chassis Based on Encoding Disk, Gyroscope and Vision (ABU ROBOCON 2014)
[![ROBOCON2014](http://img.youtube.com/vi/GRFTnDMXKEM/0.jpg)](http://www.youtube.com/watch?v=GRFTnDMXKEM "ROBOCON2014")
> The [ABU Robocon 2014](https://www.youtube.com/watch?v=GchwbtfqDzc) was conducted on 24 August 2014 at Pune, India. The Theme for Robocon 2014 declared by India was "A Salute for Parenthood". As a member of competative robotics lab of USTB, I participated in manually and automatic robots design, building. We built one manully controlled 'mother' robot which can holds the fully-automatic 'baby' robot to different mission fields and let the 'baby' automatically finish required tasks. I also took charge of the related student research training program of **Omnidirectional Mobile Chassis Based on Encoding Disk, Gyroscope and Vision** during which we developed the localization, trajectory planning and control algorithms used on 'mother' robot. We won the **1st Prize with 8th Place** in this contest.
...
> The [ABU ROBOCON 2015](https://www.youtube.com/watch?v=XiAct2sre-M) was held in August in Yogyakarta, Indonesia. The contest theme was "Robominton-Badminton RoboGame". We won the **1st Prize with 3rd Place** in this contest. As member of competative robot lab of USTB, I worked as advisor and leader of reserve team. Also I was involved in another student research training program **Vison(Kinect)-based Badminton Detection and Trajectory and Hitting Zone Estimation** during which I developed a badminton detection algorithm and was involved in trajectory and hittingzone estimation algorithm, optimized chassis control algorithm.
